...
class Lead(db.Model):
    ...
    estado = db.Column(db.String(40), nullable=False, default="Por contactar", index=True)
    ...
    data_novo_contacto = db.Column(db.Date, nullable=True, index=True)
    data_reuniao = db.Column(db.Date, nullable=True, index=True)
